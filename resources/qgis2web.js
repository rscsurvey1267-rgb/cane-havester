...
map.getView().fit([11369562.037811, 1766224.380869, 11390294.998119, 1777597.693032], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">แผนที่แปลงอ้อยที่ใช้รถตัดอ้อย ปีการผลิต 2569/70 โรงงานน้ำตาลราชสีมา</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (30 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ศูนย์สารสนเทศอ้อย กลุ่มวังขนาย';
            }
